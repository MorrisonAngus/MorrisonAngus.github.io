...
let player_turn = 'X';
const winninngPlacements = [[0, 1, 2], [3, 4, 5], [6, 7, 8],
// Horizontal
[0, 3, 6], [1, 4, 7], [2, 5, 8],
// Vertical
...
class Board extends Component {
  ...
  render() {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      boardRows.push( /*#__PURE__*/React.createElement("div", {
        className: "board-row",
        key: i
      }, row));
    }
    ...
    const titleElement = /*#__PURE__*/React.createElement("h1", null, "Tic Tac Toe - ", status);
    const boardContainer = /*#__PURE__*/React.createElement("div", {
      className: "board-container"
    }, boardRows);
    return /*#__PURE__*/React.createElement("div", null, titleElement, boardContainer);
  }
}
class Game extends Component {
  ...
  render() {
    const board = /*#__PURE__*/React.createElement(Board, {
      key: this.state.boardKey
    });
    const resetButton = /*#__PURE__*/React.createElement("button", {
      onClick: () => this.resetBoard()
    }, "Reset");
    return /*#__PURE__*/React.createElement("div", null, board, resetButton);
  }
}
const domContainer = document.querySelector('#React-game');
const boardElement = /*#__PURE__*/React.createElement(Game, null);
